...
# Reference + runnable examples for each built-in type
# =============================================
...
list_example3 = [1, "mixed", 3.14, True, None]   # mixed types allowed
...
tuple_example3 = (42,)                       # single-element tuple needs the comma
...
set_example3 = {1, 2, 2, 3, 3, 3}           # duplicates removed → {1, 2, 3}
print(f"Examples: {set_example1}, {set_example2}")


# ---------- 10. Range ----------
# Sequence of numbers generated on-the-fly
print("\n=== Range ===")
...
# ---------- 11. Function / Callable ----------
# Functions and built-in methods are also values
print("\n=== Function/Callable ===")
